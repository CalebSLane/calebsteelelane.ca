        ...
        <div className="content-wrapper">
          ...
          <div className="content ribbon l-box-lrg pure-g">
            ...
            <div className="pure-u-1 pure-u-md-1-2 pure-u-lg-3-5">
              ...
              <p>
                ...
                client looking to looking for such, BUT as a playground for me to learn and
                experiment with new technologies and have fun in my spare time, it has been a great
                success.
              </p>
            </div>
            <div className="pure-g">
              <div className="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-2-5">
                ...
                <p>
                  This website is all mine. I have designed, developed, and maintained it in my
                  spare time since its inception.
                </p>
          ...
          <div className="content l-box-lrg pure-g">
            ...
            <div className="pure-u-1 pure-u-md-1-2 pure-u-lg-3-5">
              ...
              <p>
                <a href="https://openelis-global.org/">OpenELIS-Global</a> is a Laboratory
                Information System (LIS) managed by <a href="https://digi.uw.edu/">DIGI</a> in the
                global health space that provides lab technicians with the ability to manage patient
                samples, order tests, flag important results, and auto-order potential follow up
                tests. It features extensive reporting and can communicate with other health systems
                and laboratory analyzer devices. Its use has been expanded into several countries
                around the world, including Haiti, Mauritius, and many more. Due to the nature of
                some of the labs it has to operate in, it has been designed to be operable in
                low-resource settings, including those with limited internet connectivity, power
                outages, and more.
              </p>
            </div>
            <div className="pure-g">
              <div className="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-2-5">
                ...
                <p>
                  I started with DIGI as a more junior dev, but quickly showcased my aptitudes and
                  my ability to tackle more complex problems. I have worked with the team for more
                  than 7 years and grown with the product extensively in that time. I was not
                  pigeon-holed into any one role and have worked on the products frontend, backend,
                  security, devops, interoperability, and more.
                </p>
              </div>
              <div className="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-2-5">
                <h3 className="content-subhead">
